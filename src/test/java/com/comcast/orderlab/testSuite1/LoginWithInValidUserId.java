...
public class LoginWithInValidUserId extends OrderLabTestCore {
	
	
	@Test(dataProviderClass=DataProviders.class,dataProvider= "getDataSuite1")//Change the Suite Name from Data Provider
	public void loginWithInValidUserId(Hashtable<String,String> data) throws IOException
	{
		ExcelReader excel = new ExcelReader(Constants.Suite1_TestDataPath);
		CommonUtils.checkExecution("Suite1", "LoginWithInValidUserId", data.get("RunMode"), excel);
